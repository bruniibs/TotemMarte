...
public class frmConteudo2p3 extends javax.swing.JDialog {

    /**
     * Creates new form frmConteuro
     */
    public frmConteudo2p3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTela1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/tela2.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmConteudo2p3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmConteudo2p3 dialog = new frmConteudo2p3(new javax.swing.JFrame(), true);

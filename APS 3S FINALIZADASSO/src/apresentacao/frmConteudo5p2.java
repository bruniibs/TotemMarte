...
public class frmConteudo5p2 extends javax.swing.JDialog {

    /**
     * Creates new form frmConteuro
     */
    public frmConteudo5p2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTela1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/tela8.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmConteudo5p2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmConteudo5p2 dialog = new frmConteudo5p2(new javax.swing.JFrame(), true);

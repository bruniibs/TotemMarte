...
public class frmConteudo4 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnvoltarTelaInicial3 = new javax.swing.JButton();
        ...
        btnvoltarTelaInicial3.setBackground(new java.awt.Color(79, 76, 137));
        btnvoltarTelaInicial3.setFont(new java.awt.Font("Rockwell Extra Bold", 0, 24)); // NOI18N
        btnvoltarTelaInicial3.setForeground(new java.awt.Color(255, 255, 255));
        btnvoltarTelaInicial3.setText("finalizar");
        btnvoltarTelaInicial3.setToolTipText("");
        btnvoltarTelaInicial3.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btnvoltarTelaInicial3.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnvoltarTelaInicial3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnvoltarTelaInicial3ActionPerformed(evt);
            }
        });
        getContentPane().add(btnvoltarTelaInicial3);
        btnvoltarTelaInicial3.setBounds(1280, 700, 180, 40);

        lblTela1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/tela6.png"))); // NOI18N
    ...
    private void btnvoltarTelaInicial3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnvoltarTelaInicial3ActionPerformed
        frmConteudo1 frmPS = new frmConteudo1(null, true);
        this.setVisible(false);
        frmPS.setVisible(true);
    }//GEN-LAST:event_btnvoltarTelaInicial3ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmConteudo4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmConteudo4 dialog = new frmConteudo4(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JButton btnvoltarTelaInicial3;

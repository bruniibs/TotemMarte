...
public class frmConteudo5 extends javax.swing.JDialog {

    /**
     * Creates new form frmConteuro
     */
    public frmConteudo5(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnvoltarTelaInicial1.setBounds(1290, 700, 180, 40);

        lblTela1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/tela7.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmConteudo5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmConteudo5 dialog = new frmConteudo5(new javax.swing.JFrame(), true);

...
public class frmConteudo3 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lblTela1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/tela4.png"))); // NOI18N
    ...
    private void btnvoltarTelaInicial1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnvoltarTelaInicial1ActionPerformed
        frmConteudo3p2 frmPS = new frmConteudo3p2(null, true);
        this.setVisible(false);
        frmPS.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmConteudo3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmConteudo3 dialog = new frmConteudo3(new javax.swing.JFrame(), true);

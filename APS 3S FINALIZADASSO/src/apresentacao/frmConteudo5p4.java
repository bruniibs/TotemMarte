...
public class frmConteudo5p4 extends javax.swing.JDialog {

    /**
     * Creates new form frmConteuro
     */
    public frmConteudo5p4(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnvoltarTelaInicial1.setText("finalizar");
        ...
        lblTela1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/tela10.png"))); // NOI18N
    ...
    {//GEN-HEADEREND:event_btnvoltarTelaInicialActionPerformed
        frmConteudo5p3 frmPS = new frmConteudo5p3(null, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmConteudo5p4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmConteudo5p4 dialog = new frmConteudo5p4(new javax.swing.JFrame(), true);

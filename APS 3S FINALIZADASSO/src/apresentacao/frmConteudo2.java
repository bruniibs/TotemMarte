...
public class frmConteudo2 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lblTela1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/tela3.png"))); // NOI18N
    ...
    private void btnvoltarTelaInicial1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnvoltarTelaInicial1ActionPerformed
        frmConteudo2p2 frmPS = new frmConteudo2p2(null, true);
        this.setVisible(false);
        frmPS.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmConteudo2 dialog = new frmConteudo2(new javax.swing.JFrame(), true);
